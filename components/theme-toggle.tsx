...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="rounded-md border border-gray-200 bg-white p-1.5 text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
    >
      <svg
